<?php /* Smarty version Smarty-3.1.19, created on 2015-02-21 03:43:33
         compiled from "C:\xampp\htdocs\training-grounds\ogm\themes\default-bootstrap\order-address-multishipping.tpl" */ ?>
<?php /*%%SmartyHeaderCode:719454e7f0d5c64658-35983038%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '96ef55091663f62fd9517eecf1eda09d93a0215f' => 
    array (
      0 => 'C:\\xampp\\htdocs\\training-grounds\\ogm\\themes\\default-bootstrap\\order-address-multishipping.tpl',
      1 => 1424486244,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '719454e7f0d5c64658-35983038',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_54e7f0d61d3227_63311437',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54e7f0d61d3227_63311437')) {function content_54e7f0d61d3227_63311437($_smarty_tpl) {?>
...
<?php $_tmp13=ob_get_clean();?><?php ob_start();?><?php if ($_smarty_tpl->tpl_vars['back']->value) {?><?php echo "&mod=";?><?php echo (string)$_smarty_tpl->tpl_vars['back']->value;?><?php }?><?php $_tmp14=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('address',true,null,"back=".((string)$_smarty_tpl->tpl_vars['back_order_page']->value)."?step=1".$_tmp13.$_tmp14), ENT_QUOTES, 'UTF-8', true);?>
...
<i class="icon-chevron-right right"></i></span></a>
	...
	<p class="address_add submit">
		<a href="<?php ob_start();?><?php echo urlencode('&multi-shipping=1');?>
<?php $_tmp15=ob_get_clean();?><?php ob_start();?><?php if ($_smarty_tpl->tpl_vars['back']->value) {?><?php echo "&mod=";?><?php echo urlencode($_smarty_tpl->tpl_vars['back']->value);?>
<?php }?><?php $_tmp16=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('address',true,null,"back=".((string)$_smarty_tpl->tpl_vars['back_order_page']->value)."?step=1".$_tmp15.$_tmp16), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo smartyTranslate(array('s'=>'Add'),$_smarty_tpl);?>
" class="button button-small btn btn-default"><span><?php echo smartyTranslate(array('s'=>'Add a new address'),$_smarty_tpl);?>
<i class="icon-chevron-right right"></i></span></a>
	</p>
