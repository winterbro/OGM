<?php /* Smarty version Smarty-3.1.19, created on 2015-02-20 21:52:05
         compiled from "C:\xampp\htdocs\training-grounds\ogm\admin\themes\default\template\controllers\search\helpers\view\view.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1719654e79e75317610-01139117%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '483b8e58d91eb718e7cc12d687fe1db59e65d2c4' => 
    array (
      0 => 'C:\\xampp\\htdocs\\training-grounds\\ogm\\admin\\themes\\default\\template\\controllers\\search\\helpers\\view\\view.tpl',
      1 => 1424462022,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1719654e79e75317610-01139117',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_54e79e759cd516_81988998',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54e79e759cd516_81988998')) {function content_54e79e759cd516_81988998($_smarty_tpl) {?>
...
&amp;utm_content=<?php if ($_smarty_tpl->tpl_vars['host_mode']->value) {?>cloud<?php } else { ?>download<?php }?>" class="_blank"><strong><i class="icon-external-link-sign"></i> <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['addon']->value['title'], ENT_QUOTES, 'UTF-8', true);?>
					...
					<td><a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['addon']->value['href'], ENT_QUOTES, 'UTF-8', true);?>
&amp;utm_source=back-office&amp;utm_medium=search&amp;utm_campaign=back-office-<?php echo mb_strtoupper($_smarty_tpl->tpl_vars['lang_iso']->value, 'UTF-8');?>
&amp;utm_content=<?php if ($_smarty_tpl->tpl_vars['host_mode']->value) {?>cloud<?php } else { ?>download<?php }?>" class="_blank"><?php echo htmlspecialchars($_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['truncate'][0][0]->smarty_modifier_truncate($_smarty_tpl->tpl_vars['addon']->value['description'],256,'...'), ENT_QUOTES, 'UTF-8', true);?>
</a></td>
				</tr>
			<?php } ?>
		</tbody>
