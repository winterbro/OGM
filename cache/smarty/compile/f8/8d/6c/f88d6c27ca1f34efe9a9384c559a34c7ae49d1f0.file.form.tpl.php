<?php /* Smarty version Smarty-3.1.19, created on 2015-02-21 03:43:16
         compiled from "C:\xampp\htdocs\training-grounds\ogm\admin\themes\default\template\controllers\orders\form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1448654e7f0c4b5be69-20663565%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f88d6c27ca1f34efe9a9384c559a34c7ae49d1f0' => 
    array (
      0 => 'C:\\xampp\\htdocs\\training-grounds\\ogm\\admin\\themes\\default\\template\\controllers\\orders\\form.tpl',
      1 => 1424485943,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1448654e7f0c4b5be69-20663565',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_54e7f0c5555208_66820767',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54e7f0c5555208_66820767')) {function content_54e7f0c5555208_66820767($_smarty_tpl) {?>
	...
	function updateCartVouchers(vouchers)
	{
		...
		if (typeof(vouchers) == 'object')
			$.each(vouchers, function(){
				vouchers_html += '<tr><td>'+this.name+'</td><td>'+this.description+'</td><td>'+this.value_real+'</td><td class="text-right"><a href="#" class="btn btn-default delete_discount" rel="'+this.id_discount+'"><i class="icon-remove text-danger"></i>&nbsp;<?php echo smartyTranslate(array('s'=>'Delete'),$_smarty_tpl);?>
</a></td></tr>';
			});
		...
		<div id="carrier_form">
			...
			<div class="form-group">
				<label class="control-label col-lg-3" for="shipping_price">
					<?php echo smartyTranslate(array('s'=>'Shipping price'),$_smarty_tpl);?>
	...
	<div class="panel" id="summary_part" style="display:none;">
		...
		<div id="cart_summary" class="panel row-margin-bottom text-center">
			<div class="row">
				...
				<div class="col-lg-2">
					<div class="data-focus">
						<span><?php echo smartyTranslate(array('s'=>'Total shipping'),$_smarty_tpl);?>
</span><br/>
				...
				<div class="col-lg-2">
					<div class="data-focus">
						<span><?php echo smartyTranslate(array('s'=>'Total without taxes'),$_smarty_tpl);?>
</span><br/>
				...
				<div class="col-lg-2">
					<div class="data-focus data-focus-primary">
						<span><?php echo smartyTranslate(array('s'=>'Total with taxes'),$_smarty_tpl);?>
</span><br/>
